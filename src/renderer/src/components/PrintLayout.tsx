                  ...
                  >
                    ...
                    <div className="flex flex-col mb-[1em] shrink-0">
                      <div className="flex justify-between items-end border-b-2 border-black pb-[0.5em] mb-[0.5em] pt-[0.25em]">
                        <div>
                          <h1 className="font-black text-[1.4em] uppercase tracking-wider leading-none">
                            {payslip.branch_name}
                          </h1>
                          <p className="text-[0.65em] font-bold text-gray-600 tracking-widest uppercase mt-[0.5em]">
                            Official Payslip
                          </p>
                        </div>
                        <div className="text-right">
                          <p className="text-[0.65em] font-bold text-gray-600 tracking-widest uppercase mb-[0.25em]">
                            Pay Period
                          </p>
                          <p className="text-[0.65em] font-mono font-semibold whitespace-nowrap">
                            {payslip.pay_period_start}{' '}
                            <span className="text-gray-400 mx-[0.15em]">—</span>{' '}
                      ...
                      <div className="flex items-center gap-[0.5em] mt-[0.25em] px-[0.25em]">
                        <span className="text-[0.65em] font-bold text-gray-500 uppercase tracking-widest shrink-0">
                          Employee
                        </span>
                        <span className="font-extrabold text-[0.9em] uppercase truncate">
                    ...
                    <div className="border border-gray-800 mb-[1em] grow flex flex-col">
                      ...
                      <div className="grid grid-cols-2 border-b border-gray-800 text-[0.65em] font-bold uppercase tracking-widest">
                        <div className="p-[0.75em] border-r border-gray-800 text-center">
                          Earnings
                        </div>
                      ...
                      <div className="grid grid-cols-2 text-[0.65em] grow items-start">
                        ...
                        <div className="border-r border-gray-800 p-[0.6em] flex flex-col gap-[0.4em] h-full">
                          <div className="flex justify-between items-center gap-1 w-full whitespace-nowrap">
                            ...
                            <span className="font-mono font-medium shrink-0">
                              {formatCurrency(payslip.daily_rate)}
                            </span>
                          </div>
                          <div className="flex justify-between items-center gap-1 w-full whitespace-nowrap">
                        ...
                        <div className="p-[0.6em] flex flex-col gap-[0.4em] h-full">
                          {payslip.custom_deductions?.map((deduction, idx) => (
                            <div
                              key={idx}
                              className="flex justify-between items-center gap-1 w-full whitespace-nowrap"
                            >
                          ...
                          {payslip.others_note && (
                            <div className="flex justify-between items-center gap-1 w-full whitespace-nowrap">
                              <span className="text-gray-700 font-medium truncate italic text-xs">
                                Note: {payslip.others_note}
                              </span>
                            </div>
                          )}
                        </div>
                      ...
                      <div className="grid grid-cols-2 border-t border-gray-800 font-semibold text-[0.65em] shrink-0">
                        <div className="p-[0.5em] border-r border-gray-800 flex justify-between items-center gap-1 whitespace-nowrap">
                          <span className="text-gray-800 uppercase tracking-widest text-[0.8em] truncate">
                            Total Pay
                          </span>
                    ...
                    <div className="mt-auto border-2 border-black border-dashed p-[1em] flex justify-between items-center shrink-0">
                      <div className="flex flex-col">
                        <span className="text-[0.65em] font-bold text-gray-600 uppercase tracking-widest mb-[0.25em]">
                          Take Home Pay
                        </span>
                        <span className="font-black text-[1.25em] uppercase tracking-tight">
                          Net Salary
                        </span>
                      </div>
                      <span className="font-mono font-black text-[1.5em] tracking-tighter bg-black text-white px-[0.5em] py-[0.1em] rounded-md">
